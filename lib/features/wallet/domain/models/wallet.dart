...
///
/// [firstName], [lastName], [nationality] et [birthDate] ne sont renseignés
/// qu'une fois le wallet activé ([isActivated] == true) — avant ça (ex :
/// un vendeur qui reçoit un premier `pendingAmount` sans avoir jamais activé
/// son wallet), le document Firestore ne contient que les montants, donc ces
/// champs peuvent être absents.
class Wallet {
